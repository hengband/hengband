...
static void invest_misc_hit_dice(object_type *o_ptr)
{
    ...
    if ((o_ptr->tval != ItemPrimaryType::TV_SWORD) && (o_ptr->tval != ItemPrimaryType::TV_POLEARM) && (o_ptr->tval != ItemPrimaryType::TV_HAFTED) && (o_ptr->tval != ItemPrimaryType::TV_DIGGING) && (o_ptr->tval != ItemPrimaryType::TV_GLOVES)
        && (o_ptr->tval != ItemPrimaryType::TV_RING)) {
        bonus_h /= 2;
        bonus_d /= 2;
    }
