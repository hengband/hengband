...
{
    if ((o_ptr->tval < ItemPrimaryType::TV_CLOAK) || (o_ptr->tval > ItemPrimaryType::TV_HARD_ARMOR) || o_ptr->art_flags.has(tr_sh_flag))
        return false;
...
{
    if (o_ptr->tval >= ItemPrimaryType::TV_CLOAK && o_ptr->tval <= ItemPrimaryType::TV_HARD_ARMOR)
...
{
    if (o_ptr->tval == ItemPrimaryType::TV_SHIELD || o_ptr->tval == ItemPrimaryType::TV_CLOAK || o_ptr->tval == ItemPrimaryType::TV_HELM || o_ptr->tval == ItemPrimaryType::TV_HARD_ARMOR) {
