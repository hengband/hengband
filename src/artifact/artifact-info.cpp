 ...
 * @return 発動効果のIDを返す
 */
int activation_index(player_type *player_ptr, const object_type *o_ptr)
{
 ...
 */
const activation_type *find_activation_info(player_type *player_ptr, const object_type *o_ptr)
{
