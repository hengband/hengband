...
const std::unordered_map<MonsterAbilityType, MSpellData> bolt_list = {
    ...
    { MonsterAbilityType::BO_ACID, { { _("%^sが何かをつぶやいた。", "%^s mumbles."),
    ...
    { MonsterAbilityType::BO_ELEC, { { _("%^sが何かをつぶやいた。", "%^s mumbles."),
    ...
    { MonsterAbilityType::BO_FIRE, { { _("%^sが何かをつぶやいた。", "%^s mumbles."),
    ...
    { MonsterAbilityType::BO_COLD, { { _("%^sが何かをつぶやいた。", "%^s mumbles."),
    ...
    { MonsterAbilityType::BO_NETH, { { _("%^sが何かをつぶやいた。", "%^s mumbles."),
    ...
    { MonsterAbilityType::BO_WATE, { { _("%^sが何かをつぶやいた。", "%^s mumbles."),
    ...
    { MonsterAbilityType::BO_ABYSS, { { _("%^sが何かをつぶやいた。", "%^s mumbles."),
    ...
    { MonsterAbilityType::MISSILE, { { _("%^sが何かをつぶやいた。", "%^s mumbles."),
