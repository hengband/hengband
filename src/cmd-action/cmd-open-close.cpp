...
void do_cmd_open(PlayerType *player_ptr)
{
    ...
    if (get_rep_dir(player_ptr, &dir, true)) {
        ...
        if (terrains_info[feat].flags.has_not(FloorFeatureType::OPEN) && !o_idx) {
...
void do_cmd_close(PlayerType *player_ptr)
{
    ...
    if (get_rep_dir(player_ptr, &dir, false)) {
        ...
        g_ptr = &player_ptr->current_floor_ptr->grid_array[y][x];
        feat = g_ptr->get_feat_mimic();
        if (terrains_info[feat].flags.has_not(FloorFeatureType::CLOSE)) {
...
void do_cmd_bash(PlayerType *player_ptr)
{
    ...
    if (get_rep_dir(player_ptr, &dir, false)) {
        ...
        g_ptr = &player_ptr->current_floor_ptr->grid_array[y][x];
        feat = g_ptr->get_feat_mimic();
        if (terrains_info[feat].flags.has_not(FloorFeatureType::BASH)) {
...
void do_cmd_spike(PlayerType *player_ptr)
{
    ...
    INVENTORY_IDX item;
    if (terrains_info[feat].flags.has_not(FloorFeatureType::SPIKE)) {
