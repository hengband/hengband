...
bool cast_blue_breath_acid(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_ACID, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_elec(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_ELEC, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_fire(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_FIRE, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_cold(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_COLD, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_pois(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_POIS, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_nether(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_NETH, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_lite(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_LITE, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_dark(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_DARK, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_conf(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_CONF, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_sound(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_SOUN, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_chaos(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_CHAO, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_disenchant(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_DISE, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_nexus(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_NEXU, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_time(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_TIME, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_inertia(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_INER, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_gravity(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_GRAV, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_shards(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_SHAR, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_plasma(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_PLAS, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_mana(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_MANA, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_nuke(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_NUKE, bmc_ptr->plev, DAM_ROLL);
...
bool cast_blue_breath_disintegration(player_type *caster_ptr, bmc_type *bmc_ptr)
{
    ...
    bmc_ptr->damage = monspell_bluemage_damage(caster_ptr, RF_ABILITY::BR_DISI, bmc_ptr->plev, DAM_ROLL);
