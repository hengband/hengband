...
extern concptr your_alignment(const player_type *creature_ptr);
extern int weapon_exp_level(int weapon_exp);
extern int riding_exp_level(int riding_exp);
extern int spell_exp_level(int spell_exp);

extern int calc_weapon_weight_limit(const player_type *creature_ptr);
extern WEIGHT calc_inventory_weight(const player_type *creature_ptr);

extern s16b calc_num_fire(const player_type *creature_ptr, object_type *o_ptr);
extern WEIGHT calc_weight_limit(const player_type *creature_ptr);
extern bool has_melee_weapon(const player_type *creature_ptr, int i);

extern bool heavy_armor(const player_type *creature_ptr);
extern void update_creature(player_type *creature_ptr);
extern BIT_FLAGS16 empty_hands(const player_type *creature_ptr, bool riding_control);
extern bool player_has_no_spellbooks(const player_type *creature_ptr);
...
extern long calc_score(const player_type *creature_ptr);

extern bool is_blessed(const player_type *creature_ptr);
extern bool is_time_limit_esp(const player_type *creature_ptr);
extern bool is_time_limit_stealth(const player_type *creature_ptr);
extern bool can_two_hands_wielding(const player_type *creature_ptr);
bool is_fast(const player_type *creature_ptr);
bool is_invuln(const player_type *creature_ptr);
bool is_hero(const player_type *creature_ptr);
bool is_shero(const player_type *creature_ptr);
...
extern PERCENTAGE calculate_upkeep(const player_type *creature_ptr);
extern bool music_singing(const player_type *caster_ptr, int music_songs);
