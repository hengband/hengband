...
static BIT_FLAGS check_equipment_flags(const player_type *creature_ptr, tr_type tr_flag);
 ...
 * @return 持っていたら所持前提ビットフラグを返す。
 */
BIT_FLAGS has_esp_animal(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_ESP_ANIMAL); }
 ...
 * @return 持っていたら所持前提ビットフラグを返す。
 */
BIT_FLAGS has_esp_undead(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_ESP_UNDEAD); }
 ...
 * @return 持っていたら所持前提ビットフラグを返す。
 */
BIT_FLAGS has_esp_demon(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_ESP_DEMON); }
 ...
 * @return 持っていたら所持前提ビットフラグを返す。
 */
BIT_FLAGS has_esp_orc(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_ESP_ORC); }
 ...
 * @return 持っていたら所持前提ビットフラグを返す。
 */
BIT_FLAGS has_esp_troll(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_ESP_TROLL); }
 ...
 * @return 持っていたら所持前提ビットフラグを返す。
 */
BIT_FLAGS has_esp_giant(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_ESP_GIANT); }
 ...
 * @return 持っていたら所持前提ビットフラグを返す。
 */
BIT_FLAGS has_esp_dragon(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_ESP_DRAGON); }
 ...
 * @return 持っていたら所持前提ビットフラグを返す。
 */
BIT_FLAGS has_esp_human(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_ESP_HUMAN); }
 ...
 * @return 持っていたら所持前提ビットフラグを返す。
 */
BIT_FLAGS has_esp_good(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_ESP_GOOD); }
 ...
 * @return 持っていたら所持前提ビットフラグを返す。
 */
BIT_FLAGS has_esp_nonliving(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_ESP_NONLIVING); }
 ...
 * @return 持っていたら所持前提ビットフラグを返す。
 */
BIT_FLAGS has_esp_unique(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_ESP_UNIQUE); }
...
BIT_FLAGS has_bless_blade(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_BLESSED); }

BIT_FLAGS has_easy2_weapon(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_EASY2_WEAPON); }

BIT_FLAGS has_down_saving(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_DOWN_SAVING); }

BIT_FLAGS has_no_ac(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_NO_AC); }
...
BIT_FLAGS has_mighty_throw(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_MIGHTY_THROW); }

BIT_FLAGS has_dec_mana(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_DEC_MANA); }
...
BIT_FLAGS has_see_nocto(const player_type *creature_ptr) { return creature_ptr->pclass == CLASS_NINJA ? (0x01U << FLAG_CAUSE_CLASS) : 0L; }
...
BIT_FLAGS has_anti_magic(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_NO_MAGIC); }

BIT_FLAGS has_anti_tele(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_NO_TELE); }
...
BIT_FLAGS has_easy_spell(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_EASY_SPELL); }

BIT_FLAGS has_heavy_spell(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_HEAVY_SPELL); }
...
BIT_FLAGS has_magic_mastery(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_MAGIC_MASTERY); }
...
BIT_FLAGS has_impact(const player_type *creature_ptr) { return check_equipment_flags(creature_ptr, TR_IMPACT); }
 ...
 */
bool can_attack_with_sub_hand(const player_type *creature_ptr) { return has_melee_weapon(creature_ptr, INVEN_SUB_HAND); }
...
bool has_good_luck(const player_type *creature_ptr) { return (creature_ptr->pseikaku == PERSONALITY_LUCKY) || (creature_ptr->muta3 & MUT3_GOOD_LUCK); }
...
bool has_aggravate(const player_type *creature_ptr) { return player_aggravate_state(creature_ptr) == AGGRAVATE_NORMAL; }
