...
static u32b calc_expect_dice(
    player_type *owner_ptr, u32b dam, int mult, int div, bool force, WEIGHT weight, int plus, short meichuu, bool dokubari, bool impact, int vorpal_mult, int vorpal_div)
{
