...
void set_mutation_info(player_type *creature_ptr, self_info_type *self_ptr)
{
    ...
    if (creature_ptr->muta.has(MUTA::BERS_RAGE))
    ...
    if (creature_ptr->muta.has(MUTA::ATT_ANIMAL))
    ...
    if (creature_ptr->muta.has(MUTA::XTRA_NOIS))
