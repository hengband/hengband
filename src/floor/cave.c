 ...
 */
bool is_cave_empty_bold(const player_type *player_ptr, POSITION y, POSITION x)
{
 ...
 */
bool is_cave_empty_bold2(const player_type *player_ptr, POSITION y, POSITION x)
{
 ...
 */
bool player_has_los_bold(const player_type *player_ptr, POSITION y, POSITION x)
{
 ...
 */
bool player_bold(const player_type *player_ptr, POSITION y, POSITION x) { return (y == player_ptr->y) && (x == player_ptr->x); }
