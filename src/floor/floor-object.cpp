...
{
    auto is_ammo = j_ptr->tval == ItemPrimaryType::TV_SPIKE;
    is_ammo |= j_ptr->tval == ItemPrimaryType::TV_SHOT;
    is_ammo |= j_ptr->tval == ItemPrimaryType::TV_ARROW;
    is_ammo |= j_ptr->tval == ItemPrimaryType::TV_BOLT;
