 ...
 */
object_type *choose_object(player_type *owner_ptr, OBJECT_IDX *idx, concptr q, concptr s, BIT_FLAGS option, tval_type tval, const ItemTester& item_tester)
{
    OBJECT_IDX item;
    ...
    if (!get_item(owner_ptr, &item, q, s, option, tval, item_tester))
        return NULL;
