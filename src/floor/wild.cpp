...
void init_wilderness_terrains(void)
{
    ...
    init_terrain_table(TERRAIN_MOUNTAIN, feat_mountain, "abcdef", terrain_floor, 1, terrain_id_brake, 1, terrain_id_grass, 2, terrain_id_dirt, 2, terrain_id_tree, 2, feat_mountain,
