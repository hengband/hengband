...
bool is_cave_empty_bold(const player_type *player_ptr, POSITION x, POSITION y);
bool is_cave_empty_bold2(const player_type *player_ptr, POSITION x, POSITION y);
...
bool player_bold(const player_type *player_ptr, POSITION y, POSITION x);
