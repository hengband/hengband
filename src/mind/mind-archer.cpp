...
bool create_ammo(player_type *player_ptr)
{
    ...
    case AMMO_SHOT: {
        ...
        q_ptr->prep(lookup_kind(ItemPrimaryType::TV_SHOT, (OBJECT_SUBTYPE_VALUE)m_bonus(1, player_ptr->lev) + 1));
    ...
    case AMMO_ARROW: {
        ...
        object_type forge;
        q_ptr = &forge;
        q_ptr->prep(lookup_kind(ItemPrimaryType::TV_ARROW, (OBJECT_SUBTYPE_VALUE)m_bonus(1, player_ptr->lev) + 1));
    ...
    case AMMO_BOLT: {
        ...
        object_type forge;
        q_ptr = &forge;
        q_ptr->prep(lookup_kind(ItemPrimaryType::TV_BOLT, (OBJECT_SUBTYPE_VALUE)m_bonus(1, player_ptr->lev) + 1));
