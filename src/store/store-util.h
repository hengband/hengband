...
typedef bool (*black_market_crap_pf)(const player_type *, object_type *);
typedef bool (*store_will_buy_pf)(const player_type *, object_type *);
typedef void (*mass_produce_pf)(const player_type *, object_type *);
