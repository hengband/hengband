...
/*!
 * @brief 店舗の画面の状態
 * @details 店に入っている間だけ意味を持つ、対象の店舗とその町・入店した地形・表示中のページを持つ。
 * ページの先頭は常にページの大きさの倍数になる。
 */
class StoreScreen {
public:
    StoreScreen(Store &store, size_t town_index, short terrain_id, int terminal_height);
