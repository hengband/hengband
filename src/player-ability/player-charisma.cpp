 ...
 * * 降鬼陣で加算(+5)
 */
short PlayerCharisma::battleform_value()
{
    short result = 0;
 ...
 * * 変異MUT3_SCALESで減算(-1)
 */
short PlayerCharisma::mutation_value()
{
    short result = 0;
...
short PlayerCharisma::set_exception_value(short value)
{
    short result = value;
 ...
 * * 魅力現在値をレベル依存の値に修正する。
 */
short PlayerCharisma::set_exception_use_status(short value)
{
    if (this->owner_ptr->muta.has(MUTA::ILL_NORM)) {
