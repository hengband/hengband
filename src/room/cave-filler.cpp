...
void generate_hmap(floor_type *floor_ptr, POSITION y0, POSITION x0, POSITION xsiz, POSITION ysiz, int grd, int roug, int cutoff)
{
    ...
    floor_ptr->grid_array[fill_data.ymin][fill_data.xmin].feat = (short)maxsize;
    floor_ptr->grid_array[fill_data.ymax][fill_data.xmin].feat = (short)maxsize;
    floor_ptr->grid_array[fill_data.ymin][fill_data.xmax].feat = (short)maxsize;
    floor_ptr->grid_array[fill_data.ymax][fill_data.xmax].feat = (short)maxsize;
