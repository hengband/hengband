...
{
    place_grid(*player_ptr->current_floor_ptr, grid, GB_OUTER);
    grid.set_terrain_id(TerrainTag::GLASS_WALL);
}

void place_inner_glass(PlayerType *player_ptr, Grid &grid)
{
    place_grid(*player_ptr->current_floor_ptr, grid, GB_INNER);
    grid.set_terrain_id(TerrainTag::GLASS_WALL);
}

void place_inner_perm_glass(PlayerType *player_ptr, Grid &grid)
{
    place_grid(*player_ptr->current_floor_ptr, grid, GB_INNER_PERM);
