...
bool PlayerType::is_fully_healthy() const
{
    ...
    is_fully_healthy &= !effects->blindness().is_active();
    is_fully_healthy &= !effects->confusion().is_active();
    is_fully_healthy &= !effects->poison().is_active();
    is_fully_healthy &= !effects->fear().is_active();
    is_fully_healthy &= !effects->stun().is_active();
    is_fully_healthy &= !effects->cut().is_active();
    is_fully_healthy &= !effects->deceleration().is_active();
    is_fully_healthy &= !effects->paralysis().is_active();
    is_fully_healthy &= !effects->hallucination().is_active();
