 ...
 * @details v1.1.1以上にのみ適用。angband.rc に影響があるためdefine 定数のままにしておくこと.
 */
#define H_VER_MAJOR 3 //!< ゲームのバージョン定義(メジャー番号)
#define H_VER_MINOR 0 //!< ゲームのバージョン定義(マイナー番号)
#define H_VER_STATE 1 //!< ゲームのバージョン定義(ステータス番号)
#define H_VER_BUILD 2 //!< ゲームのバージョン定義(ビルド番号)
 ...
 */
constexpr bool IS_STABLE_VERSION = (H_VER_MINOR % 2 == 0 && H_VER_BUILD == 0);
