 ...
 */
bool MonraceDefinition::is_suitable_for_dungeon(DungeonId dungeon_id) const
{
    const auto &dungeon = DungeonList::get_instance().get_dungeon(dungeon_id);
    if (this->wilderness_flags.has(MonsterWildernessType::WILD_ONLY)) {
        return dungeon.mon_wilderness_flags.has(MonsterWildernessType::WILD_MOUNTAIN) && this->wilderness_flags.has(MonsterWildernessType::WILD_MOUNTAIN);
    }

    const auto land = this->feature_flags.has_not(MonsterFeatureType::AQUATIC);
    ...
    is_mountain_monster |= dungeon.mon_wilderness_flags.has(MonsterWildernessType::WILD_MOUNTAIN) && (land || this->wilderness_flags.has(MonsterWildernessType::WILD_MOUNTAIN));
    is_mountain_monster |= dungeon.mon_wilderness_flags.has(MonsterWildernessType::WILD_VOLCANO) && (land || this->wilderness_flags.has(MonsterWildernessType::WILD_VOLCANO));
