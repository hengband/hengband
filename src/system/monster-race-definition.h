...
#define MR1_EVOLUTION 0x01
    ...
    uint r_flags1{}; //!< Observed racial flags
    uint r_flags2{}; //!< Observed racial flags
    uint r_flags3{}; //!< Observed racial flags
    uint r_flagsr{}; //!< 見た耐性フラグ / Observed racial resistance flags
