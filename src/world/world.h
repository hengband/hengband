...
struct world_type {
    ...
    uint play_time{}; /*!< 実プレイ時間 */

    uint seed_flavor{}; /* Hack -- consistent object colors */
    uint seed_town{}; /* Hack -- consistent town layout */
    ...
    uint sf_system{}; //!< OS情報 / OS information
    uint sf_when{}; //!< 作成日時 / Created Date
    ...
    uint sf_play_time{}; //!< このセーブファイルで遊んだ合計のプレイ時間
