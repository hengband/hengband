...
void MonsterLoader50::rd_monster(MonsterEntity *m_ptr_)
{
    ...
    this->m_ptr->mtimed[MonsterTimedEffect::CSLEEP] = any_bits(flags, SaveDataMonsterFlagType::CSLEEP) ? rd_s16b() : 0;
    ...
    this->m_ptr->mtimed[MonsterTimedEffect::STUNNED] = any_bits(flags, SaveDataMonsterFlagType::STUNNED) ? rd_byte() : 0;
    this->m_ptr->mtimed[MonsterTimedEffect::CONFUSED] = any_bits(flags, SaveDataMonsterFlagType::CONFUSED) ? rd_byte() : 0;
    this->m_ptr->mtimed[MonsterTimedEffect::MONFEAR] = any_bits(flags, SaveDataMonsterFlagType::MONFEAR) ? rd_byte() : 0;
    ...
    this->m_ptr->mtimed[MonsterTimedEffect::INVULNER] = any_bits(flags, SaveDataMonsterFlagType::INVULNER) ? rd_byte() : 0;
