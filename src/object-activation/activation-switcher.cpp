...
bool switch_activation(player_type *player_ptr, object_type **o_ptr_ptr, const activation_type *const act_ptr, concptr name)
{
    ...
    case RandomArtActType::ACT_BA_COLD_2:
    ...
    case RandomArtActType::ACT_SCARE_AREA:
        return activate_scare(player_ptr);
    case RandomArtActType::ACT_AGGRAVATE:
    ...
    case RandomArtActType::ACT_SUMMON_HOUND:
        return cast_summon_hound(player_ptr, (player_ptr->lev * 3) / 2);
    case RandomArtActType::ACT_SUMMON_DAWN:
        ...
        return true;
    case RandomArtActType::ACT_SUMMON_OCTOPUS:
        return cast_summon_octopus(player_ptr);
    case RandomArtActType::ACT_CHOIR_SINGS:
    ...
    case RandomArtActType::ACT_STRAIN_HASTE:
        ...
        return true;
    case RandomArtActType::ACT_FISHING:
        return fishing(player_ptr);
    case RandomArtActType::ACT_INROU:
        mitokohmon(player_ptr);
        return true;
    case RandomArtActType::ACT_MURAMASA:
        return activate_muramasa(player_ptr, o_ptr);
    case RandomArtActType::ACT_BLOODY_MOON:
        return activate_bloody_moon(player_ptr, o_ptr);
    case RandomArtActType::ACT_CRIMSON:
