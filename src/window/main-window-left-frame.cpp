...
void health_redraw(PlayerType *player_ptr, bool riding)
{
    ...
    if (w_ptr->wizard && player_ptr->phase_out) {
        ...
        if (is_valid_monster_race(player_ptr->current_floor_ptr->m_list[1].r_idx)) {
        ...
        if (is_valid_monster_race(player_ptr->current_floor_ptr->m_list[2].r_idx)) {
        ...
        if (is_valid_monster_race(player_ptr->current_floor_ptr->m_list[3].r_idx)) {
        ...
        if (is_valid_monster_race(player_ptr->current_floor_ptr->m_list[4].r_idx)) {
