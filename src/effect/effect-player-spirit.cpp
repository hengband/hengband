...
void effect_player_drain_mana(PlayerType *player_ptr, effect_PlayerType *ep_ptr)
{
...
void effect_player_mind_blast(PlayerType *player_ptr, effect_PlayerType *ep_ptr)
{
...
void effect_player_brain_smash(PlayerType *player_ptr, effect_PlayerType *ep_ptr)
{
    if ((randint0(100 + ep_ptr->rlev / 2) < std::max<short>(5, player_ptr->skill_sav)) && !check_multishadow(player_ptr)) {
        msg_print(_("しかし効力を跳ね返した！", "You resist the effects!"));
        return;
