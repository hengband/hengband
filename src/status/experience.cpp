 ...
 * Gain experience
 */
void gain_exp_64(player_type *creature_ptr, int amount, u32b amount_frac)
{
 ...
 * Gain experience
 */
void gain_exp(player_type *creature_ptr, int amount) { gain_exp_64(creature_ptr, amount, 0L); }
