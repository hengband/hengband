...
bool set_ele_attack(player_type *creature_ptr, uint attack_type, TIME_EFFECT v);
bool set_ele_immune(player_type *creature_ptr, uint immune_type, TIME_EFFECT v);
