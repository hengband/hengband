...
void wr_player(player_type *creature_ptr)
{
    ...
    for (int i = 0; i < MAX_MANE; i++) {
        wr_s16b((short)creature_ptr->mane_spell[i]);
        wr_s16b((short)creature_ptr->mane_dam[i]);
    }
    ...
    wr_s16b((short)creature_ptr->oldpx);
    wr_s16b((short)creature_ptr->oldpy);
