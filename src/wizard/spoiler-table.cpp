...
const std::vector<grouper> group_item_list = {
    { { ItemPrimaryType::TV_SHOT, ItemPrimaryType::TV_ARROW, ItemPrimaryType::TV_BOLT }, _("射撃物", "Ammo") },
    { { ItemPrimaryType::TV_BOW }, _("弓", "Bows") },
    { { ItemPrimaryType::TV_DIGGING, ItemPrimaryType::TV_POLEARM, ItemPrimaryType::TV_HAFTED, ItemPrimaryType::TV_SWORD }, _("武器", "Weapons") },
    { { ItemPrimaryType::TV_SOFT_ARMOR, ItemPrimaryType::TV_HARD_ARMOR, ItemPrimaryType::TV_DRAG_ARMOR }, _("防具 (体)", "Armour (Body)") },
    { { ItemPrimaryType::TV_BOOTS, ItemPrimaryType::TV_GLOVES, ItemPrimaryType::TV_HELM, ItemPrimaryType::TV_CROWN, ItemPrimaryType::TV_SHIELD, ItemPrimaryType::TV_CLOAK }, _("防具 (その他)", "Armour (Misc)") },

    { { ItemPrimaryType::TV_LITE }, _("光源", "Light Sources") },
    { { ItemPrimaryType::TV_AMULET }, _("アミュレット", "Amulets") },
    { { ItemPrimaryType::TV_RING }, _("指輪", "Rings") },
    { { ItemPrimaryType::TV_STAFF }, _("杖", "Staffs") },
    { { ItemPrimaryType::TV_WAND }, _("魔法棒", "Wands") },
    { { ItemPrimaryType::TV_ROD }, _("ロッド", "Rods") },
    { { ItemPrimaryType::TV_SCROLL }, _("巻物", "Scrolls") },
    { { ItemPrimaryType::TV_POTION }, _("薬", "Potions") },
    { { ItemPrimaryType::TV_FOOD }, _("食料", "Food") },

    { { ItemPrimaryType::TV_LIFE_BOOK }, _("魔法書 (生命)", "Books (Life)") },
    { { ItemPrimaryType::TV_SORCERY_BOOK }, _("魔法書 (仙術)", "Books (Sorcery)") },
    { { ItemPrimaryType::TV_NATURE_BOOK }, _("魔法書 (自然)", "Books (Nature)") },
    { { ItemPrimaryType::TV_CHAOS_BOOK }, _("魔法書 (カオス)", "Books (Chaos)") },
    { { ItemPrimaryType::TV_DEATH_BOOK }, _("魔法書 (暗黒)", "Books (Death)") },
    { { ItemPrimaryType::TV_TRUMP_BOOK }, _("魔法書 (トランプ)", "Books (Trump)") },
    { { ItemPrimaryType::TV_ARCANE_BOOK }, _("魔法書 (秘術)", "Books (Arcane)") },
    { { ItemPrimaryType::TV_CRAFT_BOOK }, _("魔法書 (匠)", "Books (Craft)") },
    { { ItemPrimaryType::TV_DEMON_BOOK }, _("魔法書 (悪魔)", "Books (Daemon)") },
    { { ItemPrimaryType::TV_CRUSADE_BOOK }, _("魔法書 (破邪)", "Books (Crusade)") },
    { { ItemPrimaryType::TV_MUSIC_BOOK }, _("歌集", "Song Books") },
    { { ItemPrimaryType::TV_HISSATSU_BOOK }, _("武芸の書", "Books (Kendo)") },
    { { ItemPrimaryType::TV_HEX_BOOK }, _("魔法書 (呪術)", "Books (Hex)") },

    { { ItemPrimaryType::TV_WHISTLE }, _("笛", "Whistle") },
    { { ItemPrimaryType::TV_CAPTURE }, _("キャプチャー・ボール", "Capture Ball") },
    { { ItemPrimaryType::TV_CARD }, _("エクスプレスカード", "Express Card") },

    { { ItemPrimaryType::TV_CHEST }, _("箱", "Chests") },

    { { ItemPrimaryType::TV_FIGURINE }, _("人形", "Magical Figurines") },
    { { ItemPrimaryType::TV_STATUE }, _("像", "Statues") },
    { { ItemPrimaryType::TV_CORPSE }, _("死体", "Corpses") },

    { { ItemPrimaryType::TV_SKELETON, ItemPrimaryType::TV_BOTTLE, ItemPrimaryType::TV_JUNK, ItemPrimaryType::TV_SPIKE, ItemPrimaryType::TV_FLASK, ItemPrimaryType::TV_PARCHMENT }, _("その他", "Misc") },
};

/* The artifacts categorized by type */
const std::vector<grouper> group_artifact_list = {
    { { ItemPrimaryType::TV_SWORD }, _("刀剣", "Edged Weapons") },
    { { ItemPrimaryType::TV_POLEARM }, _("槍/斧", "Polearms") },
    { { ItemPrimaryType::TV_HAFTED }, _("鈍器", "Hafted Weapons") },
    { { ItemPrimaryType::TV_DIGGING }, _("シャベル/つるはし", "Shovels/Picks") },
    { { ItemPrimaryType::TV_BOW }, _("飛び道具", "Bows") },
    { { ItemPrimaryType::TV_ARROW, ItemPrimaryType::TV_BOLT }, _("矢", "Ammo") },

    { { ItemPrimaryType::TV_SOFT_ARMOR, ItemPrimaryType::TV_HARD_ARMOR, ItemPrimaryType::TV_DRAG_ARMOR }, _("鎧", "Body Armor") },

    { { ItemPrimaryType::TV_CLOAK }, _("クローク", "Cloaks") },
    { { ItemPrimaryType::TV_SHIELD, ItemPrimaryType::TV_CARD }, _("盾", "Shields") },
    { { ItemPrimaryType::TV_HELM, ItemPrimaryType::TV_CROWN }, _("兜/冠", "Helms/Crowns") },
