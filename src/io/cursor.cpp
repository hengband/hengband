...
void print_path(PlayerType *player_ptr, POSITION y, POSITION x)
{
    ...
    ProjectionPath path_g(player_ptr, (project_length ? project_length : AngbandSystem::get_instance().get_max_range()), player_ptr->y, player_ptr->x, y, x, PROJECT_PATH | PROJECT_THRU);
