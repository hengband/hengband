 ...
 * * 種族による加算
 */
short PlayerStealth::race_value()
{
 ...
 * * 性格による加算
 */
short PlayerStealth::personality_value()
{
 ...
 * * 職業による加算
 */
short PlayerStealth::class_base_value()
{
 ...
 */
short PlayerStealth::class_value()
{
 ...
 * * 変異MUT3_MOTIONで加算(+1)
 */
short PlayerStealth::mutation_value()
{
    short result = 0;
 ...
 * * 隠密の歌で加算(+999)
 */
short PlayerStealth::time_effect_value()
{
    short result = 0;
 ...
 */
short PlayerStealth::set_exception_value(short value)
{
