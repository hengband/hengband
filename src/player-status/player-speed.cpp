 ...
 */
short PlayerSpeed::personality_value()
{
    short result = 0;
 ...
 */
short PlayerSpeed::special_weapon_set_value()
{
    short result = 0;
 ...
 * ** セットで加速増減があるものを計算
 */
short PlayerSpeed::equipments_value()
{
    short result = PlayerStatusBase::equipments_value();
 ...
 */
short PlayerSpeed::time_effect_value()
{
    short result = 0;
 ...
 * ** 朱雀の構えなら加算(+10)
 */
short PlayerSpeed::battleform_value()
{
    short result = 0;
 ...
 */
short PlayerSpeed::mutation_value()
{
    SPEED result = 0;
 ...
 */
short PlayerSpeed::riding_value()
{
    ...
    if (riding_m_ptr->mspeed > 110) {
        result = (short)((speed - 110) * (this->owner_ptr->skill_exp[SKILL_RIDING] * 3 + this->owner_ptr->lev * 160L - 10000L) / (22000L));
        if (result < 0)
            result = 0;
    } else {
        result = speed - 110;
 ...
 */
short PlayerSpeed::inventory_weight_value()
{
    SPEED result = 0;
 ...
 * * 探索中なら減算(-10)
 */
short PlayerSpeed::action_value()
{
    SPEED result = 0;
 ...
 * * 乗馬時 - 乗馬の速度と重量減衰のみを計算
 */
short PlayerSpeed::set_exception_value(short value)
{
    if (this->owner_ptr->riding) {
