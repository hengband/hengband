...
extern bool fire_beam(int typ, DIRECTION dir, HIT_POINT dam);
extern bool fire_bolt_or_beam(int prob, int typ, DIRECTION dir, HIT_POINT dam);
...
extern bool project_hook(int typ, DIRECTION dir, HIT_POINT dam, BIT_FLAGS flg);
