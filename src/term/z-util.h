 ...
 */
void s64b_lshift(int32_t* hi, u32b* lo, int n);
 ...
 */
void s64b_rshift(int32_t* hi, u32b* lo, int n);

extern void s64b_add(int32_t *A1, u32b *A2, int32_t B1, u32b B2);
extern void s64b_sub(int32_t *A1, u32b *A2, int32_t B1, u32b B2);
extern int s64b_cmp(int32_t A1, u32b A2, int32_t B1, u32b B2);
extern void s64b_mul(int32_t *A1, u32b *A2, int32_t B1, u32b B2);
extern void s64b_div(int32_t *A1, u32b *A2, int32_t B1, u32b B2);
extern void s64b_mod(int32_t *A1, u32b *A2, int32_t B1, u32b B2);
