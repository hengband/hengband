...
static void prt_status(void)
{
	...
	{
#ifdef JP
		c_put_str(TERM_YELLOW, "つ", ROW_STATBAR, COL_STATBAR);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_VIOLET, "幻", ROW_STATBAR, COL_STATBAR);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_L_DARK, "盲", ROW_STATBAR, COL_STATBAR+2);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_RED, "痺", ROW_STATBAR, COL_STATBAR+4);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_VIOLET, "乱", ROW_STATBAR, COL_STATBAR+6);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_GREEN, "毒", ROW_STATBAR, COL_STATBAR+8);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_L_BLUE, "視", ROW_STATBAR, COL_STATBAR+10);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_ORANGE, "テ", ROW_STATBAR, COL_STATBAR+12);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_L_BLUE, "回", ROW_STATBAR, COL_STATBAR+14);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_L_RED, "赤", ROW_STATBAR, COL_STATBAR+16);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_SLATE, "邪", ROW_STATBAR, COL_STATBAR+18);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_YELLOW, "無", ROW_STATBAR, COL_STATBAR+20);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_L_DARK, "幽", ROW_STATBAR, COL_STATBAR+22);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_SLATE, "壁", ROW_STATBAR, COL_STATBAR+22);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_SLATE, "反", ROW_STATBAR, COL_STATBAR+22);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_WHITE, "勇", ROW_STATBAR, COL_STATBAR+24);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_RED, "狂", ROW_STATBAR, COL_STATBAR+26);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_WHITE, "祝", ROW_STATBAR, COL_STATBAR+28);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_YELLOW, "魔", ROW_STATBAR, COL_STATBAR+30);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_L_UMBER, "伸", ROW_STATBAR, COL_STATBAR+30);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_WHITE, "石", ROW_STATBAR, COL_STATBAR+30);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_VIOLET, "変", ROW_STATBAR, COL_STATBAR+30);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_L_GREEN, "酸", ROW_STATBAR, COL_STATBAR+32);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_GREEN, "酸", ROW_STATBAR, COL_STATBAR+32);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_L_BLUE, "電", ROW_STATBAR, COL_STATBAR+34);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_BLUE, "電", ROW_STATBAR, COL_STATBAR+34);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_L_RED, "火", ROW_STATBAR, COL_STATBAR+36);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_RED, "火", ROW_STATBAR, COL_STATBAR+36);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_WHITE, "冷", ROW_STATBAR, COL_STATBAR+38);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_SLATE, "冷", ROW_STATBAR, COL_STATBAR+38);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_GREEN, "毒", ROW_STATBAR, COL_STATBAR+40);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_WHITE, "帰", ROW_STATBAR, COL_STATBAR+42);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_BLUE, "恐", ROW_STATBAR, COL_STATBAR+44);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_L_BLUE, "時", ROW_STATBAR, COL_STATBAR+46);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_L_BLUE, "分", ROW_STATBAR, COL_STATBAR+46);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_RED, "乱", ROW_STATBAR, COL_STATBAR+48);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_SLATE, "防", ROW_STATBAR, COL_STATBAR+50);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_YELLOW, "究", ROW_STATBAR, COL_STATBAR+52);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_L_BLUE, "浮", ROW_STATBAR, COL_STATBAR+52);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_L_DARK, "獄", ROW_STATBAR, COL_STATBAR+52);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_L_DARK, "鏡", ROW_STATBAR, COL_STATBAR+52);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_L_RED, "火", ROW_STATBAR, COL_STATBAR+54);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_WHITE, "冷", ROW_STATBAR, COL_STATBAR+54);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_L_BLUE, "電", ROW_STATBAR, COL_STATBAR+54);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_SLATE, "酸", ROW_STATBAR, COL_STATBAR+54);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_L_GREEN, "毒", ROW_STATBAR, COL_STATBAR+54);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_YELLOW, "超", ROW_STATBAR, COL_STATBAR+54);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_UMBER, "隠", ROW_STATBAR, COL_STATBAR+56);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_YELLOW, "隠", ROW_STATBAR, COL_STATBAR+56);
#else
	...
	{
#ifdef JP
		c_put_str(TERM_WHITE, "闘", ROW_STATBAR, COL_STATBAR+56);
#else
...
/* Temporary "fast" */
	...
	for (i = 0 ; i < 2 ; i++)
	{
		if(buki_motteruka(INVEN_RARM+i))
		{
			...
			if ((p_ptr->pclass == CLASS_MONK) && !(s_info[CLASS_MONK].w_max[inventory[INVEN_RARM+i].tval-TV_BOW][inventory[INVEN_RARM+i].sval]))
			{
				p_ptr->to_h[i] -= 40;
				p_ptr->dis_to_h[i] -= 40;
				p_ptr->icky_wield[i] = TRUE;
			}
			else if ((p_ptr->pclass == CLASS_FORCETRAINER) && !(s_info[CLASS_FORCETRAINER].w_max[inventory[INVEN_RARM+i].tval-TV_BOW][inventory[INVEN_RARM+i].sval]))
			{
				p_ptr->to_h[i] -= 40;
				p_ptr->dis_to_h[i] -= 40;
				p_ptr->icky_wield[i] = TRUE;
			...
			{
				if ((s_info[CLASS_NINJA].w_max[inventory[INVEN_RARM+i].tval-TV_BOW][inventory[INVEN_RARM+i].sval] <= 4000) || (inventory[INVEN_LARM-i].tval == TV_SHIELD))
				{
					p_ptr->to_h[i] -= 40;
					p_ptr->dis_to_h[i] -= 40;
					p_ptr->icky_wield[i] = TRUE;
