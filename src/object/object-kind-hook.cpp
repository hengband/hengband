...
{
    return baseitems_info.at(bi_id).bi_key.tval() == ItemKindType::CLOAK;
}
...
{
    return baseitems_info.at(bi_id).bi_key.tval() == ItemKindType::POLEARM;
}
...
{
    return baseitems_info.at(bi_id).bi_key.tval() == ItemKindType::HARD_ARMOR;
}
...
{
    return baseitems_info.at(bi_id).bi_key.tval() == ItemKindType::HAFTED;
}
...
{
    return baseitems_info.at(bi_id).bi_key.tval() == ItemKindType::POTION;
}
...
{
    return baseitems_info.at(bi_id).bi_key.tval() == ItemKindType::BOOTS;
}
...
{
    return baseitems_info.at(bi_id).bi_key.tval() == ItemKindType::AMULET;
}
