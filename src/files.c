...
display_player_flag_aux(row+4, col, "耐毒  :", TR_RES_POIS, 0, im_f, vul_f);
display_player_flag_aux(row+5, col, "耐閃光:", TR_RES_LITE, 0, im_f, vul_f);
display_player_flag_aux(row+6, col, "耐暗黒:", TR_RES_DARK, 0, im_f, vul_f);
display_player_flag_aux(row+7, col, "耐破片:", TR_RES_SHARDS, 0, im_f, vul_f);
display_player_flag_aux(row+8, col, "耐盲目:", TR_RES_BLIND, 0, im_f, vul_f);
display_player_flag_aux(row+9, col, "耐混乱:", TR_RES_CONF, 0, im_f, vul_f);
#else
...
#ifdef JP
display_player_flag_aux(row+0, col, "耐轟音:", TR_RES_SOUND, 0, im_f, vul_f);
display_player_flag_aux(row+1, col, "耐地獄:", TR_RES_NETHER, 0, im_f, vul_f);
display_player_flag_aux(row+2, col, "耐因混:", TR_RES_NEXUS, 0, im_f, vul_f);
display_player_flag_aux(row+3, col, "耐カオ:", TR_RES_CHAOS, 0, im_f, vul_f);
display_player_flag_aux(row+4, col, "耐劣化:", TR_RES_DISEN, 0, im_f, vul_f);
display_player_flag_aux(row+5, col, "耐恐怖:", TR_RES_FEAR, 0, im_f, vul_f);
display_player_flag_aux(row+6, col, "反射  :", TR_REFLECT, 0, im_f, vul_f);
display_player_flag_aux(row+7, col, "火炎オ:", TR_SH_FIRE, 0, im_f, vul_f);
display_player_flag_aux(row+8, col, "電気オ:", TR_SH_ELEC, 0, im_f, vul_f);
display_player_flag_aux(row+9, col, "冷気オ:", TR_SH_COLD, 0, im_f, vul_f);
#else
...
#ifdef JP
display_player_flag_aux(row+0, col, "加速      :", TR_SPEED, 0, im_f, vul_f);
display_player_flag_aux(row+1, col, "耐麻痺    :", TR_FREE_ACT, 0, im_f, vul_f);
display_player_flag_aux(row+2, col, "透明体視認:", TR_SEE_INVIS, 0, im_f, vul_f);
display_player_flag_aux(row+3, col, "経験値保持:", TR_HOLD_LIFE, 0, im_f, vul_f);
display_player_flag_aux(row+4, col, "テレパシー:", TR_TELEPATHY, 0, im_f, vul_f);
display_player_flag_aux(row+5, col, "遅消化    :", TR_SLOW_DIGEST, 0, im_f, vul_f);
display_player_flag_aux(row+6, col, "急回復    :", TR_REGEN, 0, im_f, vul_f);
display_player_flag_aux(row+7, col, "浮遊      :", TR_FEATHER, 0, im_f, vul_f);
display_player_flag_aux(row+8, col, "永遠光源  :", TR_LITE, 0, im_f, vul_f);
