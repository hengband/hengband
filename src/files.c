...
#ifdef JP
display_player_flag_aux(row+0, col, "耐酸  :", TR_RES_ACID, TR_IM_ACID, im_f, vul_f);
display_player_flag_aux(row+1, col, "耐電撃:", TR_RES_ELEC, TR_IM_ELEC, im_f, vul_f);
display_player_flag_aux(row+2, col, "耐火炎:", TR_RES_FIRE, TR_IM_FIRE, im_f, vul_f);
display_player_flag_aux(row+3, col, "耐冷気:", TR_RES_COLD, TR_IM_COLD, im_f, vul_f);
display_player_flag_aux(row+4, col, "耐毒  :", TR_RES_POIS, -2, im_f, vul_f);
display_player_flag_aux(row+5, col, "耐閃光:", TR_RES_LITE, -2, im_f, vul_f);
display_player_flag_aux(row+6, col, "耐暗黒:", TR_RES_DARK, -2, im_f, vul_f);
display_player_flag_aux(row+7, col, "耐破片:", TR_RES_SHARDS, -2, im_f, vul_f);
display_player_flag_aux(row+8, col, "耐盲目:", TR_RES_BLIND, -2, im_f, vul_f);
display_player_flag_aux(row+9, col, "耐混乱:", TR_RES_CONF, -2, im_f, vul_f);
#else
...
#ifdef JP
display_player_flag_aux(row+0, col, "耐轟音:", TR_RES_SOUND, -2, im_f, vul_f);
display_player_flag_aux(row+1, col, "耐地獄:", TR_RES_NETHER, -2, im_f, vul_f);
display_player_flag_aux(row+2, col, "耐因混:", TR_RES_NEXUS, -2, im_f, vul_f);
display_player_flag_aux(row+3, col, "耐カオ:", TR_RES_CHAOS, -2, im_f, vul_f);
display_player_flag_aux(row+4, col, "耐劣化:", TR_RES_DISEN, -2, im_f, vul_f);
display_player_flag_aux(row+5, col, "耐恐怖:", TR_RES_FEAR, -2, im_f, vul_f);
display_player_flag_aux(row+6, col, "反射  :", TR_REFLECT, -2, im_f, vul_f);
display_player_flag_aux(row+7, col, "火炎オ:", TR_SH_FIRE, -2, im_f, vul_f);
display_player_flag_aux(row+8, col, "電気オ:", TR_SH_ELEC, -2, im_f, vul_f);
display_player_flag_aux(row+9, col, "冷気オ:", TR_SH_COLD, -2, im_f, vul_f);
#else
...
#ifdef JP
display_player_flag_aux(row+0, col, "加速      :", TR_SPEED, -2, im_f, vul_f);
display_player_flag_aux(row+1, col, "耐麻痺    :", TR_FREE_ACT, -2, im_f, vul_f);
display_player_flag_aux(row+2, col, "透明体視認:", TR_SEE_INVIS, -2, im_f, vul_f);
display_player_flag_aux(row+3, col, "経験値保持:", TR_HOLD_LIFE, -2, im_f, vul_f);
display_player_flag_aux(row+4, col, "テレパシー:", TR_TELEPATHY, -2, im_f, vul_f);
display_player_flag_aux(row+5, col, "遅消化    :", TR_SLOW_DIGEST, -2, im_f, vul_f);
display_player_flag_aux(row+6, col, "急回復    :", TR_REGEN, -2, im_f, vul_f);
display_player_flag_aux(row+7, col, "浮遊      :", TR_FEATHER, -2, im_f, vul_f);
display_player_flag_aux(row+8, col, "永遠光源  :", TR_LITE, -2, im_f, vul_f);
display_player_flag_aux(row+9, col, "呪い      :", -1, -1, im_f, vul_f);
#else
