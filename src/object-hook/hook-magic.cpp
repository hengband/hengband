 ...
 */
bool item_tester_hook_activate(player_type *player_ptr, const object_type *o_ptr)
{
    /* Unused */
    (void)player_ptr;
 ...
 */
bool item_tester_hook_recharge(player_type *player_ptr, const object_type *o_ptr)
{
    /* Unused */
    (void)player_ptr;
