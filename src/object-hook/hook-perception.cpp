 ...
 * @return 並ならばTRUEを返す
 */
bool item_tester_hook_nameless_weapon_armour(player_type *player_ptr, const object_type *o_ptr)
{
    /* Unused */
    (void)player_ptr;
 ...
 */
bool item_tester_hook_identify(player_type *player_ptr, const object_type *o_ptr)
{
    /* Unused */
    (void)player_ptr;
 ...
 * @return 実際に鑑定済みならばTRUEを返す
 */
bool item_tester_hook_identify_weapon_armour(player_type *player_ptr, const object_type *o_ptr)
{
    /* Unused */
    (void)player_ptr;
 ...
 * @return 実際に鑑定済みならばTRUEを返す
 */
bool item_tester_hook_identify_fully(player_type *player_ptr, const object_type *o_ptr)
{
    /* Unused */
    (void)player_ptr;
 ...
 * @return 実際に鑑定済みならばTRUEを返す
 */
bool item_tester_hook_identify_fully_weapon_armour(player_type *player_ptr, const object_type *o_ptr)
{
    /* Unused */
    (void)player_ptr;
